  ...
  return (
    <nav className="navbar">
      ...
      <div className='dropdown' onMouseEnter={handleAboutEnter}
        ...
        <CSSTransition in={activeAboutDropDown} timeout={300} classNames="transition" unmountOnExit>
      ...
      <div className="dropdown" onMouseEnter={handleServicesEnter}
        ...
        <CSSTransition in={activeServicesDropDown} timeout={300} classNames="transition" unmountOnExit>
      ...
      <div className="dropdown" onMouseEnter={handleProjectsEnter}
        ...
        <CSSTransition in={activeProjectsDropDown} timeout={300} classNames="transition" unmountOnExit>
      ...
      <div className="dropdown" onMouseEnter={handleContactEnter}
        ...
        <CSSTransition in={activeContactDropDown} timeout={300} classNames="transition" unmountOnExit>
